 ...
 * 
 * dinhquangvinhdev
 * Mon Sep 22 2025 11:43:55 GMT+0700 (Indochina Time)
 * UINotiEndTime
 * db://assets/scripts/Scene/GameScene/OtherUI/UINotiEndTime/UINotiEndTime.ts
 *
 */

@ccclass('UINotiEndTime')
export class UINotiEndTime extends Component {
    ...
    public ShowNoti(cb: CallableFunction) {
        ...
        tween(this.nVisual)
            ...
            .call(() => { this.nVisual.active = false; cb && cb(); })
            .start();
    }
}