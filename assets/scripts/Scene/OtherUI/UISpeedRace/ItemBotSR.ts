...
import { InfoBot_SpeedRace, TYPE_PRIZE } from '../../../Utils/Types';
...
import { ShowItemAnim } from '../../../Common/UltimateScrollView/Type_B_ScrollViewSys';
const { ccclass, property } = _decorator;

@ccclass('ItemBotSR')
export class ItemBotSR extends ItemUltimateSV {
    ...
    private _dataItem: InfoBot_SpeedRace = null;
    ...
    public async SetUp(data: InfoBot_SpeedRace, useAnim: boolean = true) {
        ...
        switch (true) {
            ...
            case indexPlayer <= 10:
                ...
                const prizeSuitRank = DataSpeedRace.Instance.GetPrizeRank(indexPlayer - 1);
    ...
    public SetUpWithoutChangeUI(pathAvatar: string, namePlayer: string, isPlayer: boolean, dataItem: InfoBot_SpeedRace = null) {
    ...
    private OnBtnChest() {
        ...
        LogEventManager.Instance.logButtonClick(`prize`, "ItemBotSpeedRace");

        clientEvent.dispatchEvent(CONFIG_SR.NOTIFICATION.ITEMS
            , Array.from(DataSpeedRace.Instance.GetPrizeRank(this._dataItem.rank))
