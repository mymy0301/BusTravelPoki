import { _decorator, Color, Component, Label, Node, Sprite, SpriteFrame, Vec3 } from 'cc';
import { DIRECT_CAR, GetMColorByNumber, GetNumberByMColor, JsonCar, M_COLOR, TYPE_CAR_SIZE, ConvertSizeCarFromJsonToNumber, ConvertSizeCarFromJson, GetNameDirectionCar, ConvertJsonSizeBusFrenzyToSizeCar } from '../../../Utils/Types';
...
@ccclass('ItemCarOfGarage')
export class ItemCarOfGarage extends Component {
    ...
    private UpdateInfoRoot() {
        ...
        nGarage.getComponent(BuildGarage).ChangeDataCarOfGarageCars(this._idCar, this.jsonCar);
    }
    ...
    private UpdateVisual() {
        ...
        this.node.name = "CarGarageId_" + this._idCar;
    }
